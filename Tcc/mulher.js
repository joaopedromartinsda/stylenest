document.addEventListener('DOMContentLoaded', function() {
  ...
  // Oculta o carrinho inicialmente (como popup)
  ...
  // Adiciona evento para mostrar/ocultar o carrinho ao clicar no ícone
  ...
  atualizarContadorCarrinho();
  // Não mostra o carrinho automaticamente
    });
  });
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Ao carregar a página, se a flag estiver setada, não faz nada e remove a flag
  if (sessionStorage.getItem('compra-em-andamento')) {
    sessionStorage.removeItem('compra-em-andamento');
    // Impede qualquer ação de adicionar ao carrinho ao recarregar/voltar
    return;
  }
});
...
// Atualiza a lista de itens do carrinho na tela (caso exista o elemento)
function atualizarListaCarrinho() {
  ...
  carrinho.forEach(function(item, index) {
    ...
    // Exibe o nome como texto simples (sem link)
  ...
  // Adiciona o botão de comprar ao final da lista
